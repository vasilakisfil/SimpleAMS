  ...
  class Options
    ...
    def fetch_allowed_options
      ...
      if _serializer_class.is_a?(Proc) # TODO: maybe we should do duck typing instead?
        _serializer_class = collection_serializer_class
      end
    ...
    def infer_serializer
      ...
      raise "Could not infer serializer for #{resource.class}, maybe specify it? (tried #{namespace}#{resource_klass}Serializer)"
    end
